...
<execution_context>
@/home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/workflows/autonomous.md
...
<process>
Execute the autonomous workflow from @/home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/workflows/autonomous.md end-to-end.
