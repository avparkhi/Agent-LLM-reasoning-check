...
Intel system is disabled. To activate:
  ...
  node /home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/bin/gsd-tools.cjs
