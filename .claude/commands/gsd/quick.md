...
<execution_context>
@/home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/workflows/quick.md
</execution_context>
...
<process>
Execute the quick workflow from @/home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/workflows/quick.md end-to-end.
