...
<reference>
@/home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/references/user-profiling.md` to load:
