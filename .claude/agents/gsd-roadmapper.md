...
Reference full template: `/home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/templates/state.md`.
