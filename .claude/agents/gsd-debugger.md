...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/Agent-LLM-reasoning-check/.claude
                  → checks /home/user/Agent-LLM-reasoning-check/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/Agent-LLM-reasoning-check/.claude/get-shit-done
                  → writes to /home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/hooks/
...
@/home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
