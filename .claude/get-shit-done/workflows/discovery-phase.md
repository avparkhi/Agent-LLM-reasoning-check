...
See /home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/templates/discovery.md
...
Use /home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/templates/discovery.md.
