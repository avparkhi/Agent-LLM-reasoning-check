...
- Usage: Reference from command with `@/home/user/Agent-LLM-reasoning-check/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/user/Agent-LLM-reasoning-check/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/user/Agent-LLM-reasoning-check/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
